          ...
          <div class="row">
            ...
            <div class="card-body">
              ...
              <!--Try -->
				<tr>
				    <td>
				        <form action="<c:url value='/RekodRecycle/update?id=${recycleId}'/>" method="post">
				            <label for="id">ID:</label>
				            <input type="text" name="id" value="${recycleId}" readonly>
				    </td>
				    <td>
				        <label for="tarikh">Tarikh Baru:</label>
				        <input type="text" name="tarikh" required>
				    </td>
				    <td>
				        <label for="jumlah_recycle">Jumlahs Kitar Semula Baru:</label>
				        <input type="text" name="jumlah_recycle" required>
				    </td>
				    <td>
				        <label for="jumlah_bayaran">Jumlah Bayaran Baru:</label>
