      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">Nurain Najwa</span>
      ...
      <div class="row">
          ...
          <div class="row">
	          	<div class="card">
					...
					<button type="button" class="btn btn-outline-primary active">Rekod Penggunaan Elektrik</button>
				 </div>
				</div>
            ...
            <div class="card-body">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                 <c:forEach items="${wList}" var="Electric" >
				<tr>
					<td>${Electric.id}</td>
					<td>${Electric.bulan}</td>
					...
					<td><a class="button" href="<c:url value='/Electric/update?id=${Electric.id}'/>">Ubah</a>
