...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="/CarbonTracker/LamanUtama">
      ...
      <div class="row">
          ...
          <div class="row">
	          	<div class="card">
					...
					<button type="button" class="btn btn-outline-primary"><a href="BorangElektrik">Borang Penggunaan Elektrik</a></button>
					<button type="button" class="btn btn-outline-primary active" onclick="window.location.href='RekodElektrik'">Rekod Penggunaan Elektrik</button>
				 </div>
				</div>
            ...
            <div class="card-body">
              ...
              <form action="<c:url value='/RekodElektrik/getById'/>" method="post">
              ...
              <table class="table table-striped">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Jumlah Penggunaan Elektrik(kWh)</th>
				...
				<tr>
					<td>${Electric.id}</td>
					<td>${Electric.tarikh}</td>
					<td>${Electric.bilangan_hari}</td>
					<td>${Electric.faktor_prorata}</td>
					<td>${Electric.jumlah_Elektrik}</td>
					<td>${Electric.jumlah_bayaran}</td>
					<td>${Electric.jumlah_karbon}</td>
					<td><a class="button" href="<c:url value='/UpdateElectric?id=${recycle.id}'/>">Ubah</a>
						<a class="button" href="<c:url value='/Electric/delete?id=${Electric.id}'/>">Padam</a>
					</td>
				</tr>
				</c:forEach>
                </tbody>
  ...
  <!-- Vendor JS Files -->
  <script src="/CarbonTracker//CarbonTracker/resources/assets/vendor/apexcharts/apexcharts.min.js"></script>
  <script src="/CarbonTracker//CarbonTracker/resources/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
