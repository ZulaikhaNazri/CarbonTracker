      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Jejak Karbon<span>| Today</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>10,000</h6>
                      <span class="text-muted small pt-2 ps-1">Kg CO2</span><br>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Kitar Semula<span>| Today</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>200</h6>
                      <span class="text-muted small pt-2 ps-1">Kg</span><br>
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Peserta Pendahulu<span>| Today</span></h5>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Brandon Jacob</td>
                        <td><a href="#" class="text-primary">Penggunaan Air</a></td>
                        <td>$64</td>
                      ...
                      <tr>
                        ...
                        <td><a href="#" class="text-primary">Penggunaan Elektrik</a></td>
                        <td>$47</td>
                      ...
                      <tr>
                        ...
                        <td><a href="#" class="text-primary">Penggunaan Bahan Kitar Semula</a></td>
                        <td>$147</td>
                        <td><span class="badge bg-success">Approved</span></td>
                      </tr>
                      <tr>
                        ...
                        <td>Angus Grady</td>
                        <td><a href="#" class="text-primar">Penggunaan Air</a></td>
                        <td>$67</td>
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Jumlah Data<span>| Today</span></h5>
