...
public class WaterDAO{
	...
	//getAll
		...
		public int update(Water water) {
		    ...
		    Object[] args = { water.gettarikh(), water.getBilangan_hari(), water.getFaktor_prorata(), water.getJumlah_air(), water.getJumlah_bayaran(), water.getJumlah_karbon(), water.getId()};
		    int rowAffected = jdbct.update(sql, args);
		    return rowAffected;
		}
}
