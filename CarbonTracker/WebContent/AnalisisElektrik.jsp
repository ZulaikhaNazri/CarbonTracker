...
<title>Analisis Karbon Berdasarkan Penggunaan Elektrik</title>
...
<div>
    <div class="home-container">
      ...
      <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
          ...
          <ol>
            ...
            <li>Analisis Karbon Berdasarkan Penggunaan Elektrik</li>
          </ol>
        </div>
      </section>
      <!-- End Breadcrumbs -->
      ...
      <div class="formContainer">
        <h2>Analisis Karbon Berdasarkan Penggunaan Elektrik</h2>
        
        <div class="analysis-image">
          <img src="img\Karbonelektrik.png" alt="AnalisisElektrik" class="analisis-image" />
        </div>
