...
<title>Rekod Penyertaan Elektrik</title>
    ...
    <div class="home-container">
      ...
      <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
          ...
          <ol>
            ...
            <li>Rekod Penyertaan Elektrik</li>
          </ol>
        </div>
      </section>
      <!-- End Breadcrumbs -->
      ...
      <div class="formContainer">
        ...
        <b>
          ...
          <p> Faktor Porata : 1.00000 </p><br>
          <p> Penggunaan(kWh) : 186.00 </p><br>
          <p> Penggunaan(RM) : 36.83 </p><br>
        </b>
