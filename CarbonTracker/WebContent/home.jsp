...
<div>
    <div class="home-container">
      <nav class="home-nav">
        ...
        <a href="" class="home-text10">Profil</a>
      </nav>
    ...
    <!-- End Breadcrumbs -->
      <div class="home-container1">
        ...
        <div class="home-feature-card1">
          ...
          <h2 class="home-text11">Bilangan Peserta</h2>
          <span class="home-text12">
            1132 orang
          </span>
          <span class="home-text13">SEE MORE</span>
        
          <div class="home-feature-card2">
            <svg viewBox="0 0 1024 1024" class="home-icon4">
              
            </svg>
            <h2 class="home-text14">Pendahulu</h2>
            <span class="home-text15">
              Hasmi bin Asri
              9,221.25 KGCO2
            </span>
            <span class="home-text16">SEE MORE</span>
          </div>
        </div>
        <div class="home-feature-card3">
          ...
          <h2 class="home-text17">Kitar Semula</h2>
          <span class="home-text18">
            20,187.10 kg
          </span>
          <span class="home-text19">SEE MORE</span>
