...
<title>Rekod Penyertaan Bahan Kitar Semula</title>
...
<div>
    <div class="home-container">
      ...
      <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
          ...
          <ol>
            ...
            <li>Rekod Penyertaan Bahan Kitar Semula</li>
          </ol>
        </div>
      </section>
      <!-- End Breadcrumbs -->
      ...
      <div class="formContainer">
        <h2>Rekod Penyertaan Bahan Kitar Semula</h2>
        ...
        <b>
          <br><br>  
          <p> Bulan : November </p><br>
          <p> Jumlah Terkumpul(kg) : 25.00 </p><br>
          <p> Jumlah Terkumpul(RM) : 15.50 </p><br>
        </b>
